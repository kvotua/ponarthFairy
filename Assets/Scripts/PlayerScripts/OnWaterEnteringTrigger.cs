...
public class OnWaterEnteringTrigger : MonoBehaviour
{
    ...
    private void OnTriggerStay(Collider other)
    {
        ...
        {
            float difference = (other.transform.position.y - transform.position.y) * floatUpSpeed + 15f;
    ...
    private void OnTriggerExit(Collider other)
    {
        if (other.gameObject.layer == 6)
        {
            ...
            PlayerWalking._maxPlayerSpeed = 8f;
            PlayerWalking._playerAccelaration = 0.2f;
        }
    }
}
